  ...
  <body>
    ...
    <aside class="col-md-3 bg text-black menu-user" style="border-right: 1px solid; border-bottom: 1px solid;">
      <div class="row mt-4 ms-2">
        <div class="col-md-2">
          <img id="img" draggable="false" class="style-scope yt-img-shadow rounded-circle" height="30" width="30" alt=""
            src="https://yt3.ggpht.com/ytc/AIdro_kU6zYXtTUBeM5yBlPkn9wLiiImQx8v-6Qz4WwMcw=s88-c-k-c0x00ffffff-no-rj">
        </div>
        <div class="col-md-10 fw-bold">
          <a href="#" class="text-decoration-none text-black" style="margin-left: 5px;"> <span>AnhBao5CM</span></a>
        </div>
      </div>
      ...
      <div class="row mt-3 ms-2">
        ...
        <div class="col-md-10 fw-bold">
          <a href="#" class="text-black text-decoration-none" data-form="Doimatkhau" style="margin-left: 5px;"><span>Đổi
              mật khẩu</span></a>
        </div>
      </div>
      <div class="row mt-3 ms-2">
        ...
        <div class="col-md-10 fw-bold">
          <a href="#" class="text-black text-decoration-none" style="margin-left: 5px;"><span>Đăng xuất</span></a>
    ...
    <section>
      ...
      <article class="text-black" style="margin-left: 280px; margin-top: 150px;">
        <!-- FORM -->
            ...
            <form div class="col-md-10 row">
              <div class="col-md-12 d-flex">
                <div class="col-md-6 video-clip me-3">
                  <img
                    src="https://i.ytimg.com/vi/iKkYyJHTncc/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLBo88GbvVcAKJeTHb9sNv5D7vYKjg"
                    class="img-fluid mb-3" width="100%"> <br>
                </div>
                <div class="col-md-6 row">
                  <div class="col-md-10">
                    <span class="fw-bold fs-5">Pochiki Hot Drops Are INTENSE in PUBG...</span>
                    <br>
                    <span style="font-size: 15px; color: rgb(115, 107, 107);">TLTGN • 81 N lượt xem</span>
                    <br>
                    <span class="multiline-ellipsis"
                      style="font-size: 15px; color: rgb(115, 107, 107); margin-top: 10px;">
                      Có không giữ, mất thì vấn vương... Mong mọi người sẽ yêu thích và phần nào đó đồng cảm với ca
                      khúc này.
                    </span>
                  </div>
                </div>
        ...
        <div id="form5" class="form-container">Content of Form 5</div>
      </article>
